...
\ifthenelse{\equal{\backrefpagecite}{true}}{
	\usepackage[pdfencoding=auto,psdextra,backref=page, english]{hyperref} % Enlaces, referencias
}{
	\usepackage[pdfencoding=auto,psdextra, english]{hyperref} % Enlaces, referencias
}
