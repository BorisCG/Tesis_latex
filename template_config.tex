...
\def\documentparskip {13.5}           % Tamaño adicional entre párrafos (+/-) [pt]
...
\def\bibtexstyle {apalike2}          % Formato refs. bibtex {apa,ieeetr,etc...}
...
\def\natbibrefcitesepcomma {false}  % Separador en coma (,) o punto y coma (;)
...
\def\nameabstract{Abstract}            % Abstract title
\def\nameagradec{Acknowledgments}      % Acknowledgments chapter title
\def\nameappendixsection{Appendices}   % Appendices title
\def\namechapter{Chapter}              % Chapter title

% Lists and indexes
\def\nameltappendixsection{Appendix}   % Appendix section label
\def\nameltcont{Table of Contents}     % Table of contents title
\def\namelteqn{List of Equations}      % List of equations title
\def\nameltfigure{List of Figures}     % List of figures title
\def\nameltsrc{List of Code Listings}  % List of code listings title
\def\namelttable{List of Tables}       % List of tables title

% Captions
\def\nameltwfigure{Figure}             % Figure caption label
\def\nameltwsrc{Code}                  % Code caption label
\def\nameltwtable{Table}               % Table caption label

% Mathematical environments
\def\namemathcol{Corollary}            % Corollary title
\def\namemathdefn{Definition}          % Definition title
\def\namemathej{Example}               % Example title
\def\namemathlem{Lemma}                % Lemma title
\def\namemathobs{Remark}               % Remark/Observation title
\def\namemathprp{Proposition}          % Proposition title
\def\namemaththeorem{Theorem}          % Theorem title

% Miscellaneous
\def\namepageof{ of }                  % Page X of Y label
\def\nameportraitpage{Cover Page}      % Cover page label
\def\namereferences{References}        % References section title